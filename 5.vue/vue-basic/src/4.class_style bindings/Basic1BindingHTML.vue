...
// 개발자 도구에서 확인
// 이게 false이면 class="active"가 안보임.
const isActive = ref(false);
const hasError = ref(true); // or true
...
const computedObject = computed(() => ({
  ...
  'text-danger': !error.value // error.value && error.value.type === 'fatal'
}));
...
<!-- 여러 개의 클래스 바인딩 -->
<!-- isActive가 false, text-danger가 true이면, 
첫 class인 "static" 뒤에 "active"는 안보이고, "text-danger"는 보인다.-->
