...
<template>
<!-- Chrome Developer Tools - Elements에서 바인딩 여부 확인 -->

<div id="{{ dynamicId }}">값 바인딩 불가능</div>

<!-- v-bind 디렉터리를 활용하여 값 바인딩 가능-->
...
<div :id="objectOfAttrs.id" :class="objectOfAttrs.class">Multiple binding</div>

<!-- v-bind로 id, class 한번에 바인딩 됨 -->
